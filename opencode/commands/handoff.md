...
After providing your analysis and summary, write the handoff summary to a markdown file at `handoffs/[timestamp]-[slug].md` where [timestamp] is the current date in format YYYY-MM-DD and the slug is what we defined before.
