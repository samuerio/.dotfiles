...
Resumes work from a previous handoff session which are stored in `~/.config/opencode/handoffs`.
...
echo ""
for file in ~/.config/opencode/handoffs/*.md; do
  if [ -f "$file" ]; then
